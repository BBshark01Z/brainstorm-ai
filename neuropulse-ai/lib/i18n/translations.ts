...
export const translations: Record<string, TranslationEntry> = {
  ...
  "an.chart.burnoutInfo": { th: "วัดระดับความล้าและความเครียดสะสม (0-100%) ยิ่งค่าน้อยแสดงว่าสมองฟื้นตัวได้ดี", en: "Measures accumulated fatigue and stress (0-100%). A lower value means the brain recovers well." },
  "an.chart.faaInfo": { th: "ดัชนี FAA วัดสภาวะอารมณ์ ค่าเป็นบวกบ่งบอกถึงอารมณ์ผ่อนคลายและแรงจูงใจเชิงบวก", en: "Index measuring emotional state. A positive value indicates a relaxed mood and positive motivation." },
  "an.chart.spindleInfo": { th: "จำนวน Spindle ต่อนาทีขณะหลับ ยิ่งสูงยิ่งแสดงถึงประสิทธิภาพการรวมความจำ", en: "Number of spindles per minute during sleep. Higher values indicate better memory-consolidation efficiency." },
  "an.chart.swsInfo": { th: "เปอร์เซ็นต์การหลับสนิท (Deep Sleep) ช่วงเวลาซ่อมแซมร่างกายและล้างสารพิษในสมอง", en: "Percentage of deep sleep (Deep Sleep) — the period when the body repairs itself and the brain clears toxins." },
  ...
  "ai.fallbackNote": { th: "ข้อสรุปแบบ rule-based ท่ีเครื่่อง (DeepSeek ไม่ไดส่่งข้อตอบ)", en: "Local rule-based estimate (DeepSeek returned no reply)" },
